...
const StatsView: React.FC<{ stats: DashboardStats; loading?: boolean }> = ({
  ...
  return (
    <div className="p-6">
      <h1 className="mb-6 text-2xl font-bold">Statistikk</h1>

      <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
        <StatCard title="Totalt antall saker" value={stats.totalSaker} loading={loading} />
        <StatCard
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <GlassCard>
          <h2 className="mb-4 text-lg font-semibold">Statusfordeling</h2>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="w-12 text-right">
                  {Math.round((stats.pendingSaker / stats.totalSaker) * 100)}%
                </span>
              </div>
            </div>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="w-12 text-right">
                  {Math.round((stats.approvedSaker / stats.totalSaker) * 100)}%
                </span>
              </div>
            </div>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="w-12 text-right">
                  {Math.round((stats.rejectedSaker / stats.totalSaker) * 100)}%
                </span>
              </div>
            </div>
          </div>
        ...
        <GlassCard>
          <h2 className="mb-4 text-lg font-semibold">Ukentlig sammenligning</h2>
          <div className="space-y-4">
            <div className="flex justify-between">
              <span className="text-gray-600">Denne uken:</span>
              <span className="font-semibold" data-testid="this-week">
                {stats.sakerThisWeek}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Forrige uke:</span>
              <span className="font-semibold" data-testid="last-week">
                {stats.sakerLastWeek}
              </span>
            </div>
